...
export default function Home() {
  return <main>
    <nav className="nav-wrap"><div className="nav-top"><Link className="brand" href="/">PDFLUV<span>.COM</span></Link><span className="top-trust">✓ No account required</span></div><div className="nav-links"><Link href="/compression-technology">How it works</Link><Link href="/benchmarks">Benchmarks</Link></div></nav>
